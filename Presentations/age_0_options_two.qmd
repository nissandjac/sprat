...
The power law is often implemented to reduce the retrospective patterns in recruitment. However in this case the retros are only slightly different. The power law model performs slightly worse than without the power law for SBB (@fig-mohns). 
